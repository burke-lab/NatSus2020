...
Replication materials for [_Heft-Neal, Burney, Bendavid, Voss & Burke (2020)_](https://www.nature.com/articles/s41893-020-0562-1).
...
Script 04 processes data for figure 2 panels b and c (slow, >30 min if you run 1,000 iterations)
...
Script 08 processes data for figure 4 (script 00 must be run first. slow, >30 min if you run 1,000 iterations)
...
Script 19 will processe the raw exposure data for all DHS locations. Note the processed output cannot be merged with the birth data. This script is a work in progress (see above for details).
