...
#save coefficients
save(beta_dust_share, beta_dust_timing, file = "data/intermediate_outputs/permutation_test_coefs_dust.RData")


#load coefficients for plotting 
load("data/intermediate_outputs/permutation_test_coefs_dust.RData")
...
hist(fs_est_tm,axes=F, xlab = "",ylab = "", main = "", breaks=15, ylim = c(0,500), col = add.alpha('gray90', 0.5), 
...
#save coefficients
save(beta_dust_share_rain, beta_rain_timing, file = "data/intermediate_outputs/permutation_test_coefs_rain.RData")


#load coefficients for plotting 
load("data/intermediate_outputs/permutation_test_coefs_rain.RData")
...
hist(fs_est_tm,axes=F, xlab = "",ylab = "", main = "", breaks=15, ylim = c(0,600), col = add.alpha('gray90', 0.5), 
